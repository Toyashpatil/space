...
const page = () => {
  ...
  return (
    <main className='crew_page space-y-2'>
            ...
            <div className=' h-[400px] w-[80%] flex-wrap justify-center space-y-10 mt-10'>
              <div className='flex-col justify-center space-y-5'>
                <div className='flex items-center justify-start'>
                  <h1 className="text-[32px] text_one opacity-60 ">{crewInfo[slideIndex].post}</h1>
                </div>
                <div className='flex items-center justify-start'>
                  <h1 className=" text_one text-[56px] ">{crewInfo[slideIndex].name}</h1>
                </div>
            ...
            <div>
              <div className='flex gap-5 items-end justify-start mt-10 '>
                <button onClick={() => {
                  ...
                  <div className='h-[10px] w-[10px] bg-white cursor-pointer rounded-full '>
      ...
      <div className='Navbar_mobile justify-center space-y-2'>
        <div className='flex justify-center items-center '>
          <div className=' w-[80%] h-[200px] flex justify-center'>
        ...
        <div className='flex items-center justify-center'>
          <div className='flex items-center justify-start'>
            <h1 className="text-[16px] text_one opacity-60 ">{crewInfo[slideIndex].post}</h1>
          </div>
        ...
        <div className='flex items-center justify-center'>
          <div className='flex items-center justify-start'>
            <h1 className="text-[15px] text-[#D0D6F9] text-center text_one  ">{crewInfo[slideIndex].desc}</h1>
          </div>
